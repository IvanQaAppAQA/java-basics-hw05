...
public class Zoo {
    ...
    public static void feed(List<?> list) {
        ...
        list.forEach(Bird::eat);// TODO feed birds in the cycle
    }
    ...
    public static void acceptBird(List<? super FlyingBird> list, FlyingBird bird) {
        ...
        bird.checkWings();// TODO check flying bird wings
        list.add(bird);
        list.forEach(System.out::println);    // TODO add a bird to the list and print it
    }
    ...
    public static void registerBird(List<Bird> list, Bird newBird) {
        ...
        list.add(newBird);// TODO add a bird to list
        list.forEach(System.out::println);// TODO print birds in the cycle
    }
}